...
import createScreenOptions from '@libs/Navigation/AppNavigator/createScreenOptions';
import * as Session from '@userActions/Session';
import OnyxUpdateProvider from '@components/OnyxUpdateProvider';
...
function AuthScreens() {
    ...
    return (
        <NavigationContainer linking={linking} onStateChange={onStateChange} onReady={onReady} ref={navigationRef}>
            <OnyxUpdateProvider />
            <WalletProvider>
            <Stack.Navigator
                screenOptions={{
