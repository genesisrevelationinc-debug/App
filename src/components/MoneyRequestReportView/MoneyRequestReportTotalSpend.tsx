...
function MoneyRequestReportTotalSpend({
    ...
    const sidebarWidth = isSidebarCollapsed ? 76 : 250; // 76px when collapsed, 250px when expanded
    const isCollapsed = isSidebarCollapsed || isHovering;

    return (
        <View style={[StyleSheet.absoluteFill, {width: isCollapsed ? 76 : sidebarWidth}]}>
            <Animated.Text
