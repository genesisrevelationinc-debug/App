...
const ONYXKEYS = {
    ...
    /** The bank account selected to be used for the wallet */
    SELECTED_WALLET_BANK_ACCOUNT_ID: 'selectedWalletBankAccountID',
    ...
    /** Is report data loading? */
    [ONYXKEYS.NVP_ONBOARDING]: OnyxTypes.Onboarding;
    [ONYXKEYS.NVP_ONBOARDING_PURPOSE_SELECTED]: string;
    [ONYXKEYS.USER_WALLET]: OnyxTypes.UserWallet;
    [ONYXKEYS.USER_WALLET_BALANCE]: number;
    [ONYXKEYS.SELECTED_WALLET_BANK_ACCOUNT_ID]: string;
